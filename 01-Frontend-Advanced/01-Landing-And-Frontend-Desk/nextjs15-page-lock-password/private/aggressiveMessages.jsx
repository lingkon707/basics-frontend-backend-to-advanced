...
export default function PrivatePage() {
  ...
  const aggressiveMessages = [
      `Excuse me? This ain't your place, mate.`,
  `Hang on... who gave you access?`,
  `Nice try, but you're not getting in.`,
  `Whoa there! Back it up, this are not off-limits.`,
  `Caught ya! You're not cleared for this.`,
  `Seriously? You think we would not notice?`,
  `Nope. Not today. Not ever.`,
  `Buddy, you're way outta bounds!`
  ]
  ...
  const startAggressiveMode = () => {
    ...
    setTimeout(() => {
      ...
      setError(false)
      setErrorMessage("")
    }, 15000) // 15 seconds of aggressive mode
  }
