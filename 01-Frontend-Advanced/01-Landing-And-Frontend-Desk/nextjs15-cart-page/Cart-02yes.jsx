        ...
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {products.map((product) => (
              <div
                key={product.id}
                className="bg-gray-900/80 rounded-3xl shadow-lg overflow-hidden hover:shadow-cyan-400/50 transition-shadow duration-300"
              >
                <img
                  src={product.image}
                  alt={product.name}
                ...
                <div className="p-5 space-y-3">
                  ...
                  <button
                    ...
                    className="mt-3 bg-cyan-500 hover:bg-cyan-600 text-gray-900 font-semibold py-2 px-4 rounded-lg shadow-lg transition-all duration-300"
                  >
                    Add to Cart
                  </button>
                </div>
                  ...
                  >
                    ...
                    <div className="flex-1 flex flex-col gap-2">
                      ...
                      <div className="flex items-center gap-3 mt-2">
                        ...
                        <span className="text-gray-200 font-medium px-2">
                          {item.quantity}
                        </span>
                        <button
