...
export default function CartPage() {
  ...
  const checkoutHandler = () => {
    ...
    if (paid < total) {
      setMessage('⚠️ Payment insufficient. Please pay full amount.');
    } else if (paid === total) {
      setMessage('🎉 Order Confirmed! Thank you for your payment.');
    } else {
      const change = (paid - total).toFixed(2);
      setMessage(`✅ Order Confirmed! Change Returned: $${change}`);
    }
  };
