...
export default function ResumePage() {
  ...
  const handleDownloadPDF = () => {
    ...
    const scale = 2.5; // Improve quality
    ...
    const param = {
      ...
      quality: 1,
      cacheBust: true,
      bgcolor: '#1f2937', // Tailwind bg-gray-900
    };
    ...
    domtoimage.toPng(node, param)
      .then((dataUrl) => {
        const pdf = new jsPDF({
          ...
          unit: 'px',
          format: [param.width, param.height],
        });

        pdf.addImage(dataUrl, 'PNG', 0, 0, param.width, param.height);
        pdf.save('Lingkon_Resume_HQ.pdf');
      })
      .catch((err) => {
