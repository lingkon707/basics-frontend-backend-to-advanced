...
const justifyitems = () => {
  return (
    ...
    <main>
      <h1 className="bg-amber-950 text-4xl text-white">How padding works here - justify-items-center-safe</h1>
      <br /> <br />

          <div className="grid grid-cols-3 gap-4 justify-items-center-safe bg-black">
