  ...
  return (
    <div className="min-h-screen p-8 bg-gray-100">
      <div className="grid grid-cols-4 gap-8">
        {/* Blog Section - 3/4 Width */}
        <div className="col-span-3 bg-white shadow-xl rounded-3xl p-10 overflow-y-auto">
          <h1 className="text-5xl font-bold mb-6 text-gray-900">National Crisis</h1>
          ...
          <h2 className="text-3xl font-semibold mt-8 mb-4 text-gray-800">1. The Root Causes</h2>
          ...
          <h2 className="text-3xl font-semibold mt-8 mb-4 text-gray-800">2. The Human Toll</h2>
          <p className="mb-6 text-gray-700 text-lg leading-relaxed">
          ...
          <h2 className="text-3xl font-semibold mt-8 mb-4 text-gray-800">3. Role of Leadership</h2>
          <p className="mb-6 text-gray-700 text-lg leading-relaxed">
          ...
          <h2 className="text-3xl font-semibold mt-8 mb-4 text-gray-800">4. Collective Responsibility</h2>
          <p className="mb-6 text-gray-700 text-lg leading-relaxed">
            Citizens too play a role. From grassroots movements to civic
            participation, every voice contributes to shaping the response.
          </p>

          <h2 className="text-3xl font-semibold mt-8 mb-4 text-gray-800">5. Path Toward Resolution</h2>
          <p className="mb-6 text-gray-700 text-lg leading-relaxed">
          ...
          <blockquote className="border-l-4 border-blue-500 pl-6 italic text-gray-600 my-8 text-lg">
        ...
        {/* Advertisement Section - 1/4 Width */}
        <div className="relative">
          <div className="fixed top-8 right-8 w-72 bg-white shadow-md rounded-3xl p-4 flex items-center justify-center min-h-[300px]">
            {showAd && currentAd ? (
