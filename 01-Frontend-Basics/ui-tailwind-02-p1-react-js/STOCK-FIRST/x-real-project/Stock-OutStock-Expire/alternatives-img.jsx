...
export default function Main() {
  ...
  return (
    <div className="p-8 max-w-6xl mx-auto">
      <h1 className="text-3xl font-bold text-center mb-8">🛒 Product alternatives </h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {products.map((originalProduct) => {
          ...
          const expired = isExpired(originalProduct.expiry); // use original expiry
          const outOfStock = !originalProduct.stock; // use original stock
