...
export default function BlogDetails({ blog, onNext, onPrev, currentIndex, totalBlogs }) {
  return (
    <article className="max-w-5xl mx-auto px-6 py-16 bg-gradient-to-tr from-indigo-50 via-white to-indigo-50 rounded-3xl shadow-xl mb-16">
      ...
      {/* Navigation Buttons */}
      <div className="flex justify-between max-w-3xl mx-auto mt-16">
        <button
          onClick={onPrev}
        ...
        <span className="self-center text-indigo-700 font-medium">
          {currentIndex + 1} / {totalBlogs}
        </span>
        <button
          onClick={onNext}
          className="px-6 py-3 bg-indigo-600 text-white font-semibold rounded-lg shadow-md hover:bg-indigo-700 transition"
