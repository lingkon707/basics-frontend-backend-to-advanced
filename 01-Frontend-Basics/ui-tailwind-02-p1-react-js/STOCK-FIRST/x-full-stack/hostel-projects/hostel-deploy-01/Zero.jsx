...
import hostelData from "./hostel.json"; // make sure hostel.json is in same folder

export default function Dashboard() {
  // Helper: calculate total meals for each student
          ...
          <tbody>
            {Object.entries(hostelData.dailyBazar).map(([day, info], idx) => (
              ...
              >
                ...
                <td className="px-4 py-2">
                  {hostelData.students[idx]?.roomNumber || "-"}
                </td>
