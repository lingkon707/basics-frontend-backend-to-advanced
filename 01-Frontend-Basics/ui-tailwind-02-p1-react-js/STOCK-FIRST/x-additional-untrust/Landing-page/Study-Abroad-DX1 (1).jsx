      ...
      <div className="max-w-7xl mx-auto text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-8">
          {tools.map((tool, index) => (
            <div key={index} className="relative bg-white p-6 rounded-xl shadow-xl hover:shadow-2xl transition-shadow duration-300 group">
              <img
                src={tool.image}
                alt={tool.title}
                className="w-full h-48 object-cover rounded-md mb-4 transition-all duration-500 transform group-hover:scale-105"
              />
