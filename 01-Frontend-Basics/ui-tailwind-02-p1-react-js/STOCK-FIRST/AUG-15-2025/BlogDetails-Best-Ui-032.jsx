  ...
  return (
    <div className="min-h-screen bg-gray-50 font-serif text-gray-900">
      ...
      <main className="max-w-6xl mx-auto px-6 py-10 grid grid-cols-1 lg:grid-cols-4 gap-10">
        ...
        {/* Sidebar - Recent Posts, Search, Categories, Tags */}
        <aside className="space-y-6">
          <h3 className="text-2xl font-extrabold border-b-4 border-orange-400 inline-block pb-2 mb-4">
            Recent Posts
          </h3>
          ...
          <div className="mb-6">
            <input
              ...
              className="w-full rounded-md border border-gray-300 px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-orange-400"
            />
          </div>
          ...
          {/* Categories Section */}
          <section>
            <h3 className="text-xl font-extrabold border-b-2 border-orange-400 inline-block pb-1 mb-4">
              Category
            </h3>
          ...
          <section>
            ...
            <div className="flex flex-wrap gap-2">
              {popularTags.map((tag, idx) => (
                <button
                  key={idx}
                  className="text-xs font-semibold border border-gray-300 px-3 py-1 rounded-md hover:border-orange-400 hover:text-orange-500 transition"
                >
                  {tag}
                </button>
              ))}
